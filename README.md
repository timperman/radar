...
|---|---|---|---|
| 🆕 [GitLab](https://github.com/timperman/radar/issues/19) | [🔍 Assess](#-Assess) | Tool | GitLab is a web-based DevOps lifecycle tool that provides<br> a Git-repository manager providing wiki, issue-tracking<br> and CI/CD pipeline features. |
